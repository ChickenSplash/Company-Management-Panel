                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <x-sortable-companies-column label="Employees" column="employees_count" :sortBy="$sortBy" :sortDirection="$sortDirection"/>
                    ...
                    <tbody>
                        @foreach ($companies as $company)
                            <tr class="clickable-row" data-href="{{ route('companies.show', $company->id) }}">
                                ...
                                <td class="numbered-cell">{{ $company->employees_count }}</td>
                                <td>{{ $company->email }}</td>
